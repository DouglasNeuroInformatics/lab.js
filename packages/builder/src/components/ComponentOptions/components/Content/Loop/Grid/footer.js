...
const GridFooter = ({ addItem, columns }) => {
            ...
            <DropdownMenu right>
              ...
              <Uploader
                ...
                onUpload={([[content]]) => {
                  ...
                  const parseResult = parse(content.trim(), { header: true })
                  ...
                  if (
                    ...
                    overwriteAll(
                      ...
                      Object.keys(parseResult.data[0]).map((c) => ({
                        name: c,
                        type: 'string',
                      })),
                    )
                  } else {
                    console.log('CSV import found errors: ', parseResult.errors)
                    alert(
